...
# Fetches public IP from external services and POSTs it to the registry (compatible with the original Worker behavior).

:local URL "http://YOUR_PUBLIC_HOST_OR_IP:8080/device/YOUR_ROUTER_NAME"
